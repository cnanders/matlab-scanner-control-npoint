classdef GetLogical < mic.ui.device.GetSetLogical
    ...
    methods       
        ...
        % approach but I think it is a decent one.
            ...
            this@mic.ui.device.GetSetLogical(varargin{:});
