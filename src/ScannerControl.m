...
% calculate the waveforms and plot them
    ...
    methods (Access = private)
        ...
        function updateAxes(this)
            ...
            this.cTitlePreview = 'Waveform Preview';
            ...
            if ishandle(this.hFigure) & ... 
               ...
               ishandle(this.hPreviewAxis1D)
                ...
                title(this.hPreviewAxis1D, this.cTitlePreview);
        ...
        function updateAxesLC400Read(this)
            
            % NEED TO FIX!!
            
            this.cTitlePreview = 'LC400 Wavetable';
        ...
        function updateAxesLC400Record(this)
...
%                 hold on
                ...
                title(this.hMonitorAxis1D, 'LC400 Recorded Sensor & Command')
        ...
        function buildPlotPreviewPanel(this)
            ...
            this.hPreviewAxis1D = axes(...
                ...
                'Units', 'pixels',...
                'Position',mic.Utils.lt2lb([dPad + 15 dTop dSize*2 - 15 dSize], this.hPlotPreviewPanel),...
                'XColor', [0 0 0],...
                'YColor', [0 0 0],...
                'HandleVisibility','on'...
                );
            ...
            this.hPreviewAxis2D = axes(...
                'Parent', this.hPlotPreviewPanel,...
                'Units', 'pixels',...
                'Position',mic.Utils.lt2lb([2*(dPad+dSize) dTop dSize dSize], this.hPlotPreviewPanel),...
                'XColor', [0 0 0],...
                'YColor', [0 0 0],...
            ...
            this.hPreviewAxis2DSim = axes(...
                'Parent', this.hPlotPreviewPanel,...
                'Units', 'pixels',...
                'Position',mic.Utils.lt2lb([3*(dSize+dPad) dTop dSize dSize], this.hPlotPreviewPanel),...
                'XColor', [0 0 0],...
                'YColor', [0 0 0],...
                'DataAspectRatio',[1 1 1],...
                'HandleVisibility','on'...
        ...
        function buildPlotMonitorPanel(this)
            ...
            this.hMonitorAxis1D = axes(...
                ...
                'Units', 'pixels',...
                'Position',mic.Utils.lt2lb([dPad + 15 dTop dSize*2 - 15 dSize], this.hPlotMonitorPanel),...
                'XColor', [0 0 0],...
                'YColor', [0 0 0],...
                'HandleVisibility','on'...
                );
            ...
            this.hMonitorAxis2D = axes(...
                'Parent', this.hPlotMonitorPanel,...
                'Units', 'pixels',...
                'Position',mic.Utils.lt2lb([2*(dPad+dSize) dTop dSize dSize], this.hPlotMonitorPanel),...
                'XColor', [0 0 0],...
                'YColor', [0 0 0],...
                'DataAspectRatio',[1 1 1],...
                'HandleVisibility','on'...
            ...
            this.hMonitorAxis2DSim = axes(...
                'Parent', this.hPlotMonitorPanel,...
                'Units', 'pixels',...
                'Position',mic.Utils.lt2lb([3*(dSize+dPad) dTop dSize dSize], this.hPlotMonitorPanel),...
                'XColor', [0 0 0],...
                'YColor', [0 0 0],...
                'DataAspectRatio',[1 1 1],...
                'HandleVisibility','on'...
